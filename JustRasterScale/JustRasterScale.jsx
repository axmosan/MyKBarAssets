(function() {
    ...
    app.beginUndoGroup("Just Raster Scale & Center Align");
    ...
    for (var i = 0; i < selLayers.length; i++) {
        ...
        if (layer.source instanceof CompItem) {
            ...
            if (rect.width > 0 && rect.height > 0) {
                ...
                // サイズ取得不可の場合はスキップ
                // alert("レイヤー " + layer.name + " のサイズ取得不可。"); 
                continue;
            }
        }
        ...
        // コンポジションに収まるスケール率を計算 (Fit to Comp / アスペクト比維持)
        var scale = Math.min((comp.width / srcW) * 100, (comp.height / srcH) * 100);
